...
<ComponentPreview
  ...
  description="Basic history list with timestamps"
  className="mb-4"
/>
...
<ComponentPreview
  ...
  description="History items with edit and delete actions"
  className="mb-4"
/>
...
<ComponentPreview
  ...
  description="History items with icons and badges"
  className="mb-4"
/>
...
<ComponentPreview
  ...
  description="Different states of history items"
  className="mb-4"
/>
...
<ComponentPreview
  ...
  description="Complete history list with star feature"
  className="mb-4"
/>
