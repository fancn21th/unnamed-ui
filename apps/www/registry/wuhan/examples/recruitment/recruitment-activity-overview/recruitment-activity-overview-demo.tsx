...
import { RecruitmentActivityOverview } from "../../../recruitment/RecruitmentActivityOverview";

export default function RecruitmentActivityOverviewDemo() {
  const dataSource = {
    introductionData: {
      goalDescription:
        "本次招聘活动需要在 年底前 ，招聘 1 个AI产品经理，2 个前端开发工程师。",
      completedText: "1 个前端开发工程师 的招聘。",
      analysisLink: "https://www.bing.com",
      progress: 45,
      status: "hasRisk",
      riskWarning:
        "在当前招聘节奏与条件下，按期完成招聘目标的确定性不足，若不进行调整，存在较高延期或失败概率。",
    },
    positionGoalList: [
      {
        id: "1",
        name: "AI 产品经理",
        description:
          "年底前，以快速补位为目标，优先选择具备业务理解与推进能力的 “AI产品经理” ，允许技术深度阶段性不足，但不接受稳定性或协作风险。",
      },
      {
        id: "2",
        name: "前端开发工程师",
        description:
          "年底前，在严格控制成本的前提下招聘前端开发工程师，优先满足业务落地能力，对非核心能力保持弹性，但不接受明显能力断层。",
      },
    ],
