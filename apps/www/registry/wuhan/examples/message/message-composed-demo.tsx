...
import { AIMessage, UserMessage, MessageAIPrimitive, MessageUserPrimitive } from "@/registry/wuhan/blocks/message/message-01";
...
function MessageItemRenderer({ message, onFeedbackChange }: MessageItemRendererProps) {
    const handleCopy = () => {
    ...
    return (
        <div className="flex justify-start w-full">
            <div className="w-fit max-w-full group/message">
                ...
                <div className="flex justify-end opacity-0 group-hover/message:opacity-100 transition-opacity min-h-[32px]">
                    {message.feedback && (
                        <FeedbackButtons feedback={feedbackProps} />
                    )}
                </div>
            </div>
        </div>
